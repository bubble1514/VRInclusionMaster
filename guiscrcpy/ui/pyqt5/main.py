...
"")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/guiscrcpy_side_panel.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.check_side_panel.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/icons/gear.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/icons/android.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon12)
...
"")
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/icons/small-rocket-ship-silhouette.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.executeaction.setIcon(icon13)
...
"            "))
        ...
        self.quit.setStatusTip(_translate("MainWindow", "Выйти и завершить все процессы"))
